...
class OnBoardingScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
        child: Scaffold(
      body: Padding(
        padding: EdgeInsets.only(top: 54.h, left: 20.w, right: 20.w,bottom: 32.w),
        child: Column(
          ...
          children: [
            ...
            Column(
              children: [
                RedButton(
                    text:'Complete onboarding', onPressed: () {},color: const Color(0xFFFBD4D5),width: 335.w,),
                SizedBox(
                  height: 16.h,
                ),
                WhiteButton(text: 'Log out', onPressed: () {},width: 335.w,),
              ],
            ),
          ],
        ),
